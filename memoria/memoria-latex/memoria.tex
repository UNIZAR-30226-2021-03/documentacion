...
\textbf{P.EC.8} Proceso de nombrado de archivos. Consiste en asegurar que todos los archivos del proyecto sigan la convención de nombrado establecida en el plan asociado.
...
\subsubsection{Planes asociados procesos de ejecución y control}
...
\textbf{PL.EC.4 Plan de control de esfuerzo:}
...
\subsubsection{Planes asociados procesos técnicos}
...
Durante la fase de preparación del proyecto se llevó a cabo una estimación del tiempo necesario para completar el proyecto
