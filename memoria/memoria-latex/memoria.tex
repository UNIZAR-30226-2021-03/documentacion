...
\end{figure}
\begin{figure}[H]
   \includegraphics[width=.8\textwidth]{../images/Tabla_Conclusiones_Versionado.png.png}
...
\end{figure}
\begin{figure}[H]
   \includegraphics[width=.8\textwidth]{../images/Tabla_Conclusiones_Requisitos.png.png}
...
\addcontentsline{toc}{section}{Anexo III. API del backend}
\markdownInput{../markdown/README.md}
